...
attacks can be executed remotely, not requiring physical access to the
...
corruption. The goal of the HS3 workshop was to provide a forum for
...
For HS3 2025 we were looking for submissions that propose new processor
...
fuzzing or other attack approaches. HS3 2025 also had a special theme on
\enquote{Secure Monitoring, Intrusion Detection, and Incident Response} and
we were specifically inviting submissions that present hardware-assisted
approaches in this domain.

Given that HS3 is a very young workshop that was running for the first time
in co-location with ESORICS, our call for papers attracted significant
interest and resulted in 14 submissions. Each manuscript underwent a
rigorous peer-review process, with 3 single-blinded reviewers per paper,
and guaranteeing that chairs and committee members would not review their
own or otherwise conflicting submissions. Ultimately, we accepted 3 regular
papers and 4 short papers, achieving a 50\,\% acceptance rate.
...
was well frequented and promoted lively discussions around recent trends in
hardware-supported security and on application-related topics.

We would like to thank our invited speaker, Dr. Robert Norton, for
